...
LinearOptimizer::LinearOptimizer(std::unique_ptr<AbstractFunction> f, std::unique_ptr<Criterion>, double step) :
    Optimizer(std::move(f), std::make_unique<NWithoutUpdates>(10)),
